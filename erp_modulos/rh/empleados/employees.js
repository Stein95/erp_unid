        ...
        .then(response => {
            const rows = response.data.map((data, id) => (
                `<tr style="text-align: justify">
                 ...
                 <td>
                 <button class="btn btn-sm btn-info" id="btn-view" data=${data.id}  data-name="${data.name}"><i class="fas fa-eye"></i></button>
                 <button class="btn btn-sm btn-primary" id="btn-edit" data-toggle="modal" data-target="#modal-edit" data=${data.id}  data-name="${data.name}"><i class="fas fa-edit"></i></button>
                 <button class="btn btn-sm btn-danger" id="btn-delete" data-toggle="modal" data-target="#modal-delete" data=${data.id} data-name="${data.name}"><i class="fas fa-user-minus"></i></button>
                 </td>
                 </tr>`
            ));
